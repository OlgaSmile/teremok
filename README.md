...
Створення нового блок-компоненту

1. В папці blocks створюємо нову папку блоку з файлами .php .scss .js (за необхідності)
2. Підключаємо файл .php у файлі blocks_init.php
3. В адмінці додаємо цей блок через Гутенберг

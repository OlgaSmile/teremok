...
<section class="teremok-section">
  ...
  <div class="teremok-section__mobile-wrapper">
    <div class="teremok-section__box-center">
      <div class="teremok-section__title">
        <?php get_template_part("template-parts/section-title", null, ['title' => get_field('location_title', 'option')]); ?>
      </div>
      ...
      <?php if (!empty($repeater_field)) : ?>
          ...
          <?php foreach ($repeater_field as $index => $row) : ?>
            ...
            ?>
              <li class="teremok-section__item">
                ...
                <p><?php echo esc_html($row['teremok_repeating_name']); ?></p>
              </li>
        ...
        <?php if (!empty($Images_left)) : ?>
          <div class="teremok-section__Image-mobile">
            <div class="swiper swiper-image-mobile">
              <div class="swiper-wrapper">
                <?php foreach ($Images_left as $image) : ?>
                  <div class="swiper-slide">
                    <img src="<?php echo esc_attr($image['url']); ?>" alt="<?php echo esc_attr($image['alt']) ?: 'image'; ?>">
                  </div>
                <?php endforeach; ?>
              </div>
      ...
      <?php if (!empty($teremok_main_field)) : ?>
        <div class="teremok-section__owner-block">
          <?php foreach ($teremok_main_field as $row) : ?>
            <div class="teremok-section__owner-block">
              <?php foreach ($teremok_main_field as  $index => $row) : ?>
                <div class="teremok-section__owner-block-img-box">
                  <svg xmlns="http://www.w3.org/2000/svg" width="163" height="162" viewBox="0 0 163 162" fill="none">

...
if (!empty($hero_active_image)) {
    ...
    get_template_part("template-parts/secondary-hero-section", null, ['img_array' => $hero_active_image, "title_section" => get_the_title()]);
        ...
        <img class="activities-main__decor-1"
            src="<?php echo get_template_directory_uri() . '/assets/images/decor-branch-left.png'; ?>" alt="">
...
?>
    ...
    <section class="section-activity">
        <img class="section-activity__decor2"
            src="<?php echo get_template_directory_uri() . '/assets/images/decor-branch.png'; ?>" alt="">
        <?php
...
if ($number_of_posts >= 5): ?>
            <img class="activity-nearby__decor-1"
                src="<?php echo get_template_directory_uri() . '/assets/images/decor-trees1.png'; ?>" alt="">
            <img class="activity-nearby__decor-2"
                src="<?php echo get_template_directory_uri() . '/assets/images/decor-trees2.png'; ?>" alt="">
            <?php endif?>
    ...
    while ($query->have_posts()): $query->the_post();
        ...
        ?>
		            ...
		            <div class="activity-nearby__item">
		                ...
		                <img class="activity-nearby__item-decor-1"
		                    src="<?php echo get_template_directory_uri() . '/assets/images/decor-trees2.png'; ?>" alt="">
		                <?php endif?>
	                <?php if ($index === 16 && $number_of_posts >= 24): ?>
	                <img class="activity-nearby__item-decor-2"
	                    src="<?php echo get_template_directory_uri() . '/assets/images/decor-trees2.png'; ?>" alt="">
	                <?php endif?>
...
?>
                ...
                <div class="activity-nearby__item-text-box">
                    ...
                    <div class="activity-nearby__distance-wrapper">
                        ...
                        <img width="24" height="24" src="<?php echo get_field("distance_icon", "options")['url'] ?>"
                            alt="<?php echo get_field("distance_icon", "options")['alt'] ?>">
                        <?php endif?>
                        <p><?php echo $rowDistance['from'] === true ? 'від' : '' ?>
                            <?php echo $rowDistance['distance'] ?> <?php echo $rowDistance['select'] ?></p>
                    </div>
                    ...
                    <div id="activity-content-<?php echo $post_id ?>" class="activity-nearby__content-mobile">
                        ...
                        <img class="section-activity-content__item-content-img"
                            src="<?php echo get_field("mountains_green_icon", "options")['url'] ?>"
                            alt="<?php echo get_field("mountains_green_icon", "options")['alt'] ?>">
                        <?php endif?>
                        <div>
                    ...
                    <div class="activity-nearby__item-bottom-wrapper">
                        ...
                        <a href="#post-<?php echo $post_id ?>"
                            class="activity-nearby__detalies-btn"><?php echo get_field('more-details', 'options') ? get_field('more-details', 'options') : 'Детальніше' ?>
                            <svg class="activity-nearby__detalies-btn-mobile-icon" xmlns="http://www.w3.org/2000/svg"
                                width="13" height="30" viewBox="0 0 13 13" fill="none">
                                <path
                                    d="M12.5 5.48431C10.3365 5.99923 6.0094 8.02326 6.0094 12M6.0094 12C3.75648 5.80609 0.885307 5.15897 0.5 5.15897M6.0094 12L6.0094 -2.83713e-07"
                                    stroke="#E67739" />
                            </svg>
                        </a>

                        <button id="activity-<?php echo $post_id ?>" class="activity-nearby__detalies-btn-mobile"><span
                                id="text-more-<?php echo $post_id ?>"><?php echo get_field('more-details', 'options') ? get_field('more-details', 'options') : 'Детальніше' ?></span>

                            <svg id='activity-icon-<?php echo $post_id ?>'
                                class="activity-nearby__detalies-btn-mobile-icon" xmlns="http://www.w3.org/2000/svg"
...
?>
    ...
    get_template_part("template-parts/section-title-secondary", null, array('title' => get_the_title()))?>
                    ...
                    <p><?php echo $rowDistance['from'] === true ? 'від' : '' ?> <?php echo $rowDistance['distance'] ?>
                        <?php echo $rowDistance['select'] ?></p>
                </div>
                <?php endforeach?>
                <?php endif?>
            </div>

...
$hero_reviews_image = get_field('hero_business_image');
$histry_title = get_field('business_introduction_title');
$history_desc = get_field('business_introduction_text');
$history_img = get_field('business_introduction_owner_photo');
...
<main>
  ...
  <section class="section-business-history">
    ...
    <?php if (!empty($history_img)): ?>
      <div class="teremok-section__owner-block-img-box">
        ...
        <img src="<?php echo esc_url($history_img['url']) ?>" alt="<?php esc_attr($history_img['alt']); ?>" />
      </div>
  ...
  <?php get_template_part("templates/business/description") ?>
  <?php get_template_part("templates/business/infrastructure") ?>
  <?php get_template_part("templates/business/conditions") ?>
  <?php get_template_part("templates/business/advantages") ?>
  <?php get_template_part("templates/business/business-success") ?>
  <?php get_template_part("templates/business/details_agreement_form") ?>
  <?php

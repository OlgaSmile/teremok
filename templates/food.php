...
$additional_fee = get_field('food_page_additional_fee_food');
...
$img_reserve = get_field('img_reserve')
?>
...
<main class="food_page">
    ...
    <?php
get_template_part("template-parts/section-reserve", null, ['image' => $img_reserve]);

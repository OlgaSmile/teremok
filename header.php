...
<body>
    ...
    <svg width="33" height="58" viewBox="0 0 33 58" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16.2109 57.5V0.0625" stroke="#fff" stroke-width="1.5" />
        <path
    ...
    <svg width="24" height="41" viewBox="0 0 24 41" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.7451 40.4999V0.273926" stroke="#fff" stroke-width="1.5" />
        <path
...
<?php the_field('phone', "option");?>" class="header__phone"><?php the_field('phone', "option");?></a>
        ...
        <header class="header-mobile">
            ...
            <?php get_template_part("template-parts/logo_mobile");?>

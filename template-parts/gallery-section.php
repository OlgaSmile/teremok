<?php
if (isset($args['photos']) || isset($args['video'])) {
    $gallery = $args['photos'];
...
<section class="section-gallery">
    ...
    <div class="masonry">
        ...
        <?php
if ($index == 0 || $index == 2) {
    echo 'masonry-item-size2';
}

if ($index == 3) {
    echo 'masonry-item-height2';
}

if ($index == 4 || $index == 6) {
    echo 'masonry-item-height';
}
...
?>">
            ...
            <video id="video-player" class="custom-video-player" controls autoplay muted loop>
                <source src="<?php echo $video_url ?>" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            <?php else: ?>
            <img class="masonry-item__img" src="<?php echo esc_attr($image['url']); ?>"
                alt="<?php echo esc_attr($image['alt'] ? $image['alt'] : 'Галерея'); ?>" />
            <?php endif;?>

...
get_template_part("template-parts/section-title", null, ['title' => $add_feedback_title]);?>
        ...
        <form id="feedback-form" method="post" enctype="multipart/form-data" class="form-feedback"
            ...
            <div class="form-feedback__user-name">
                ...
                <input id="feedback_name" type="text" name="feedback_name" placeholder="" minlength="2" min='2' max="10"
                    required>
            ...
            <div class="form-feedback__user-photo-wrapper">
                ...
                <div class="user-image-box">
                    <div class="custom-user-photo-input">
                        <img id="default-user-img" class="default-user-img"
                            src="<?php echo get_template_directory_uri() ?>/assets/images/user-photo-form.svg" ?>
                        <img id="user-img" class="user-img" src="" />
                        <input tabindex="0" id="user-file" type="file" name="feedback_person_photo" accept="image/*"
                            max="1">
                    </div>
...
?>
            ...
            <div class="form-feedback__add-images-wrapper">
                ...
                <div class="custom-add-images">
                    <div class="custom-add-photos-input">
                        <img class="animation-input-img-other"
                            src="<?php echo get_template_directory_uri() ?>/assets/images/add-images.svg" ?>
                        <div class="add-img-wraper">
                            <img class="animation-input-img"
                                src="<?php echo get_template_directory_uri() ?>/assets/images/add-photos-camera.svg" ?>
                        </div>
                        <img class="animation-input-img-other"
                            src="<?php echo get_template_directory_uri() ?>/assets/images/add-images.svg" ?>
                    ...
                    <div class="custom-images-wrapper">
                        ...
                        <div><button id="next-add-images" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="19" viewBox="0 0 18 19"
                                    ...
                                    <line x1="18" y1="9.5" x2="-8.74228e-08" y2="9.5" stroke="#689762"
                                        stroke-width="2" />
                                </svg>
                            </button></div>
                    </div>
            ...
            <div class="form-feedback__text-box">
                <label id="plahceholder-text"
                    class="feedback-text-placeholder"><?php echo $user_reviews_desc_placeholder ?><span
                        class="asterisk">*</span></label>
                <textarea id="feedback-text" name="feedback_text" rows="1" minlength="40" maxlength="1000"
    ...
    <div id="feedback-response" class="feedback-response">
        <button class="feedback__modal-close" type="button" id="js-close-feedback-response-form"
